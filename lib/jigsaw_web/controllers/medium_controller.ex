defmodule JigsawWeb.MediumController do
  ...
  def medium(conn, %{"imagePath" => image_path}) do
    ...
    # puzzle_pieces_path = "priv/static/images/puzzle-pieces/medium/#{base_image_name}-pieces/"
    puzzle_pieces_path = "priv/static/images/puzzle-pieces/medium/"
    ...
    render(conn, "medium.html", layout: false, image_path: relative_image_path, puzzle_pieces: shuffled_files, level: level)
  end
end
